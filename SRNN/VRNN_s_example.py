...
if torch.cuda.is_available() :
    model = VRNN(n_input, n_hidden, n_layers, nonlinearity=nonlinearity).cuda()
else :
...
srnn_pred = pd.DataFrame({'real_y' : real_y, 'vrnn_y' : hat_y})
srnn_pred.to_csv('vrnn_pred.csv')